...
public class AgentWhatsApp {
    ...
    @JoinColumn(name = "user_id", nullable = false, foreignKey = @ForeignKey(name = "fk_agents_whatsapp_user_id"))
    @JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
    private User user;
    ...
    // Constructors
    public AgentWhatsApp() {}
    
    public AgentWhatsApp(String name, String description, String prompt) {
        this.name = name;
