package com.dashboardai.security;

import com.dashboardai.security.jwt.AuthEntryPointJwt;
import com.dashboardai.security.jwt.AuthTokenFilter;
import com.dashboardai.security.services.UserDetailsServiceImpl;
        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource))
            ...
            .authorizeHttpRequests(auth ->
                auth.requestMatchers("/api/auth/**").permitAll()
                    ...
                    .requestMatchers("/api/conversation-logs/**").permitAll()  // Permitir acceso a conversation logs sin autenticación
