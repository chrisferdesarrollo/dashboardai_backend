...
public class N8nTestConnectionRequest {
    ...
    public N8nTestConnectionRequest() {}
    
    public N8nTestConnectionRequest(String n8nUrl, String apiKey) {
        this.n8nUrl = n8nUrl;
        this.apiKey = apiKey;
    }
    ...
    public String toString() {
        return "N8nTestConnectionRequest{" +
                "n8nUrl='" + n8nUrl + '\'' +
